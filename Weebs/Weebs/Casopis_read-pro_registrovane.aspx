<%@ Page Language="C#" Theme="Casopis_read" AutoEventWireup="true" CodeFile="Casopis_read-pro_registrovane.aspx.cs" Inherits="Casopis_read"%>
...
<body style="background-color:#4F7D82"  >
     ...
     <h1 style="color: #FFFFFF"> Všechna čísla šasopisu</h1>
      <div>
        </div>

    <form id="form1" runat="server" >
     
 <p></p>  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  Text="Odhlásit se" href="#" class="button" /> </p>
