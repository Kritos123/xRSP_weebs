...
<body style="background-color:#4F7D82">
    <form id="form1" runat="server">
        ...
        <div style="margin: auto; background-image: url('/Obrazky/login.png'); height: 437px; width: 901px; height: 437px; width: 903px;">
            <asp:Button ID="Button1" runat="server" CssClass="button" style="position: relative; top: 358px; left: 721px; width: 114px; height: 30px" Text="Přihlásit se" OnClick="Button1_Click"   />
            ...
            <asp:TextBox ID="Password_textbox" runat="server" style="position: relative; top: 287px; left: 5px; height: 53px; width: 358px" TextMode="Password" OnTextChanged="Password_textbox_TextChanged"></asp:TextBox>
             <asp:Button ID="Button2" runat="server"  CssClass="button"  OnClick="Button2_Click" style="position: relative; top: -53px; left: 721px; width:125px; height: 30px" Text="Hlavní stránka" />
             </div>
    </form>
</body>
</html>
