...
<body style="background-color:#4F7D82">
    <form id="form1" runat="server">
        ...
        <div style="margin: auto; background-image: url('login.png'); height: 437px; width: 901px; height: 437px; width: 903px;">>
            ...
            <asp:TextBox ID="Login_textbox" runat="server" style="position: relative; top: 154px; left: 367px; height: 54px; width: 352px; margin-top: 0px;" OnTextChanged="Login_textbox_TextChanged"></asp:TextBox>
